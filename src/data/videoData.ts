...
export const MINIGAME_VIDEO_MAP: { [key: string]: string } = {
    ...
    // "2-3" (Дада-комплимент) не имеет видео
    ...
    "5-1": "https://vkvideo.ru/video-126259657_456239048",      // Приготовление Аладок
    "5-2": "https://www.youtube.com/watch?v=VTaSn3mymIw",       // Поцелуй Добра
    "6-1": "https://www.youtube.com/watch?v=29p14n_qeN0",       // Фруктовый Спор
    "6-2": "https://www.youtube.com/watch?v=29p14n_qeN0",       // Не Подавись!
